...
class _RoomScreenState extends State<RoomScreen> {
  ...
  Future<void> _showAddCommentSheet(
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Add comment', style: Theme.of(ctx2).textTheme.titleLarge),
                const SizedBox(height: 12),
                // Star rating
                Row(
                  ...
                  SliverAppBar(
                    ...
                    flexibleSpace: FlexibleSpaceBar(
                      ...
                      background: CachedNetworkImage(
                        imageUrl: (state.property?.images.isNotEmpty ?? false)
                            ? state.property!.images.first
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverList(
                      delegate: SliverChildListDelegate([
                        ...
                        if (state.property?.images.isNotEmpty ?? false)
                          ImageCarousel(
